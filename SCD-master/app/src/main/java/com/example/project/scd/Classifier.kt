...
//class Classifier berfungsi untuk memuat model dan membaca file berlabel
class Classifier(assetManager: AssetManager, modelPath: String, labelPath: String, inputSize: Int) {
    ...
    //baris 27-35 adalah class hasil data
    ...
    // setelah kita memiliki instance interpreter, disini kita mengconvert bitmap yang telah diproses sebelumnya
    //menjadi ByteBuffer, lalu kita membuat method yang akan menggunakan gambar sebagai argumen dan mengembalikan
    //daftar label dengan probabilitas yang ditetapkan
    ...
    //baris 69-82 berfungsi untuk menconvert bitmap to bytebuffer
    ...
    //baris 88-114 berfungsi mendapatkan result yang sudah diurutkan
